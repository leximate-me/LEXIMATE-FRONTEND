...
function CreateTaskModal({ isOpen, onClose }) {
    ...
    const onSubmit = handleSubmit(async (data) => {
        ...
        try {
            // Llamada a la función createTask para hacer el POST al backend
    ...
    return (
        <>
            ...
            >
                ...
                <div ref={modalRef} onClick={(e) => e.stopPropagation()} className="bg-white p-8 rounded-lg shadow-[0px_7px_8px_-4px_rgba(0,0,0,0.53)] max-w-md w-full relative">
