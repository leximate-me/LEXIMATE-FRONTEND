        ...
        <div className="flex flex-wrap justify-center items-center w-[90%] m-5">
          {classes &&
            classes.map((classItem, index) => (
              <div
                key={index}
                className="bg-white shadow-[0px_9px_15px_-7px_rgba(0,0,0,0.75)] rounded border p-4 m-5 w-[300px] flex flex-col items-center gap-3 hover:scale-110 transition duration-300"
              >
