              ...
              <div className="flex flex-col gap-5 md:flex-row items-center">
                <div className="flex gap-2 px-3">
                  ...
                  >
                    ...
                    <div
                      ref={dropdownRef}
                      className={`absolute right-8 top-12 mt-2 w-fit flex flex-col bg-white dark:bg-gray-800 rounded-lg shadow-lg p-3 transition-all duration-300 ease-out transform ${
                        isProfileOpen
