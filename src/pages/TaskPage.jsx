...
function TaskPage({ tasks: initialTasks }) {
  ...
  const { extractText, extractedText, isExtracting, setExtractedText } =
    useTool();
  const {
    register,
    handleSubmit,
  ...
  const getFileIcon = (fileType) => {
    ...
    if (fileType.includes("image"))
      return <FaFileImage size={40} className="text-green-600" />;
            ...
            <div className="grid grid-cols-8 grid-rows-[190px_auto] gap-4">
              ...
              <div className="col-span-6 row-span-1 bg-white rounded-lg shadow-md flex flex-col">
                <div className="p-3 rounded-t-lg flex justify-between bg-gradient-to-r from-yellow-300 to-amber-400">
                  <HighlightLetter
                    size="text-2xl"
                    className="font-opendyslexic mb-2"
                  >
                    {task.title}
                  </HighlightLetter>
                  ...
                  {task.taskFiles?.length > 0 ? (
                    <>
                      ...
                      <div className="h-fit col-start-7 col-span-2 row-start-3 row-span-2 bg-white rounded-lg shadow-md flex flex-col">
                              ...
                              submittedTasks.map((sub) => (
                                ...
                                >
                                  {sub.submissionFiles.length > 0 ? (
                                    ...
                                    >
                                      {getFileIcon(
                                        sub.submissionFiles[0]?.file_type,
                                      )}
                                      <p className="text-sm text-gray-700 truncate max-w-[150px] text-center">
                                    ...
                                    <HighlightLetter
                                      color="red"
                                      size="text-sm"
                                      className="mt-4 font-opendyslexic"
                                    >
                                      No entregado
                                    </HighlightLetter>
                                  )}
                                  {sub.qualification === null ? (
                                    <button
                                      onClick={() =>
                                        handleDeteleSubmission(sub.id)
                                      }
                                      className="w-1/2 bg-gray-300 rounded p-1 mt-1 hover:bg-gray-400 transition-all"
                                    >
                                      <HighlightLetter
                                        size="text-sm"
                                        color="red"
                                  ...
                                  >
                                    <div className="flex flex-col gap-3 w-full">
                                      <HighlightLetter
                                        ...
                                        r="red"
                                        size="text-md"
                                        className="font-opendyslexic tracking-more-wide"
                                      >
                                    ...
                                    <button
                                      type="submit"
                                      className="w-1/2 bg-[#89dfbf] hover:bg-[#78c4a8] transition-all rounded p-2 mt-3"
                                    >
                                      <HighlightLetter
                                        color="green"
                                        size="text-sm"
                        ...
                        {mySubmission &&
                          mySubmission.qualification !== null && (
                              ...
                              {mySubmission.comment && (
                                <div className="mt-2 flex justify-start">
                                  <div className="bg-white p-3 w-full rounded-r-lg rounded-bl-lg shadow-md max-w-xs break-words">
                                    <HighlightLetter
                                      size="text-lg"
                                      className="font-opendyslexic text-gray-800"
                                    >
                                      {mySubmission.comment}
                                    </HighlightLetter>
                                    <HighlightLetter
                                      size="text-xs"
                                      color="green"
                                      className="font-opendyslexic text-gray-500 block mt-1"
                                    >
                                      Profesor
                                    </HighlightLetter>
                                  </div>
                    ...
                    <div className="h-fit col-start-7 col-span-2 row-start-1 row-span-2 bg-white rounded-lg shadow-md flex flex-col">
                      <div className="p-3 rounded-t-lg bg-gradient-to-r from-yellow-300 to-amber-400">
                        <HighlightLetter
                          size="text-xl"
                          className="font-opendyslexic"
                        ...
                        {submittedTasks && submittedTasks.length > 0 ? (
                          submittedTasks.map((sub) => (
                            ...
                            >
                              ...
                              {sub.qualification === null ? (
                                <button
                                  onClick={() => handleDeteleSubmission(sub.id)}
                                  className="w-1/2 bg-gray-300 rounded p-1 mt-1 hover:bg-gray-400 transition-all"
                                >
                                  <HighlightLetter
                                    size="text-sm"
                  ...
                  <div className="col-span-6 h-fit max-h-[500px] row-start-2 row-span-4">
                    {studentsWithSubmissions.length > 0 ? (
                      <div className="border-8 border-[#f7d654] rounded-3xl p-3 bg-white h-full shadow-md overflow-auto tracking-more-wide">
                        <HighlightLetter
                          size="text-2xl"
                          className="font-opendyslexic mb-4"
                        >
                          Entregas:
                        </HighlightLetter>
                        {studentsWithSubmissions.map(
                          ({ student, submission }) => (
                            <div
                              key={student.id}
                              className="m-2 flex items-center justify-between bg-pastelVeryLightYellow rounded-lg p-3 mb-3"
                            >
            ...
            <div className="flex flex-col justify-center items-center">
              <div className="bg-pastelYellow p-10 rounded-lg shadow-md flex flex-col justify-center items-center">
                ...
                <HighlightLetter
                  color="red"
                  size="text-lg"
                  className="font-opendyslexic mt-4"
                >
                  Tarea no encontrada
                </HighlightLetter>
              </div>
